...
def main():
    ...
    bf_out = JBF.joint_bilateral_filter(img_rgb, img_rgb).astype(np.uint8)  #bilateral
    jbf_out = JBF.joint_bilateral_filter(img_rgb, guidance).astype(np.uint8)    #joint bilateral    
